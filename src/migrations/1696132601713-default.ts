...
export class Default1696132601713 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "location" point NOT NULL, "createdDate" TIMESTAMP NOT NULL, "closedDate" TIMESTAMP NOT NULL, "createdByUserId" integer NOT NULL, "categoryId" integer NOT NULL, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
